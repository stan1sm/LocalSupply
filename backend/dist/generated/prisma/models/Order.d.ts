...
export type OrderOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"id" | "buyerId" | "supplierId" | "status" | "subtotal" | "deliveryFee" | "total" | "notes" | "createdAt" | "updatedAt", ExtArgs["result"]["order"]>;
